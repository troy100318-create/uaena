...
type LinkSignupElementOptions = "createLinkSignupElement" extends keyof stripeJs.StripeCheckout ? stripeJs.StripeCheckout extends {
    createLinkSignupElement(...args: infer Args): any;
} ? NonNullable<Args[0]> : LinkSignupElementOptionsFallback : LinkSignupElementOptionsFallback;
/**
...
type LinkSignupElementInstanceFallback = stripeJs.StripeElementBase & {
    on<EventType extends keyof LinkSignupElementEventMap>(eventType: EventType, handler: (event: LinkSignupElementEventMap[EventType]) => any): LinkSignupElementInstanceFallback;
    once<EventType extends keyof LinkSignupElementEventMap>(eventType: EventType, handler: (event: LinkSignupElementEventMap[EventType]) => any): LinkSignupElementInstanceFallback;
    off<EventType extends keyof LinkSignupElementEventMap>(eventType: EventType, handler?: (event: LinkSignupElementEventMap[EventType]) => any): LinkSignupElementInstanceFallback;
};
type LinkSignupElementInstance = "getLinkSignupElement" extends keyof stripeJs.StripeCheckout ? stripeJs.StripeCheckout extends {
    getLinkSignupElement(...args: any[]): infer Element;
} ? NonNullable<Element> : LinkSignupElementInstanceFallback : LinkSignupElementInstanceFallback;
interface LinkSignupElementProps extends ElementProps {
    /**
     * An object containing Element configuration options.
     */
...
type LinkSignupElementComponent = FunctionComponent<LinkSignupElementProps>;
...
declare module "@stripe/stripe-js" {
    interface StripeElements {
         ...
         */
        getElement(component: LinkSignupElementComponent): LinkSignupElementInstance | null;
        /**
...
type StripeCheckoutActions = Omit<stripeJs.StripeCheckout, "session" | "on" | "getLinkSignupElement"> & {
    /**
...
declare const useCheckout: () => CheckoutContextValue;
 ...
 * Requires `@stripe/stripe-js` version 7.10.0 or later.
 */
declare const LinkSignupElement: LinkSignupElementComponent;
/**
 * @docs https://stripe.com/docs/stripe-js/react#element-components
 */
